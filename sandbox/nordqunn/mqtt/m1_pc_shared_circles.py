...
# Also someone should update the libs/mqtt_remote_method_calls.py file on the robot too (at some point before kirbyes).
...
def main():
    ...
    # mqtt_client = None #commented out instead of deleting
