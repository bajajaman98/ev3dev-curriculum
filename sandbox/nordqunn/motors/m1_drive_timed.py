...
#     900 degrees / second  -->  traveled 45 inches  -->  9 inches / second (probably no faster than 800)
#
...
#
#   NOTE: Note: To repeat again, in later modules you will learn different (better) ways to travel a given distance
# using
